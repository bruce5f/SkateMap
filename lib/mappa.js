...
var TileMap = function () {
  ...
  _createClass(TileMap, [{
    ...
    value: function resize(canvas) {
      ...
      var diff = [this.mappaDiv.offsetWidth - canvas.width, this.mappaDiv.offsetHeight - canvas.height];
      console.log(diff[0]);
      ...
      var cnvs = this.canvas.getContext('webgl') || canvas.canvas.getContext('2d');
      cnvs.canvas.style.transform = 'translate(' + diff[0] + 'px, ' + diff[1] + 'px)';

      console.log(cnvs.canvas.style.transform);
